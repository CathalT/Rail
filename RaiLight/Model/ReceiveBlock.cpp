...
namespace rail
{
    namespace blocks
    {
        Receive::Receive(const ByteArray32 & _previousBlock, const ByteArray32 & _sourceBlock, const SecureContainer<ByteArray32>& _privateKey, const ByteArray32 & _publicKey) :
