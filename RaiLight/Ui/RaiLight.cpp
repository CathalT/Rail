...
void RaiLight::onSendButtonPressed()
{
...
void RaiLight::onAccountIndexChanged(const QString & text)
{
...
void RaiLight::onBalanceUpdated(const QString & balance, const QString& accountId)
{
...
void RaiLight::onPendingBalanceUpdated(const QString & pendingBalance, const QString& accountId)
{
    if (accountId == ui.accountsListComboBox->currentText())
    {
...
void RaiLight::onAccountsFinishedSyncing()
{
...
void RaiLight::onTransactionsUpdated(const QString& accountId)
{
    if (accountId == ui.accountsListComboBox->currentText())
    {
        QStringList strList;
